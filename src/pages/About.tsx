  ...
  return (
    <div className="pt-24 min-h-screen bg-transparent pb-24 relative z-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
        <div className="bg-slate-900/40 backdrop-blur-3xl rounded-[2rem] shadow-2xl border border-white/10 overflow-hidden text-white">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="h-96 md:h-auto relative overflow-hidden bg-slate-900">
              <img 
                src="https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                alt="Owner of Siyaraam Car Rental"
            ...
            <div className="p-10 md:p-16 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 tracking-tighter">Meet The Owner</h2>
