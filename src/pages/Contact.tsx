      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <motion.div 
            ...
            className="bg-slate-900/40 backdrop-blur-3xl p-8 md:p-12 rounded-[2rem] shadow-2xl border border-white/10"
          >
            ...
            <div className="space-y-8">
              ...
              <a href="tel:+919017130046" className="flex items-start group">
                <div className="w-14 h-14 bg-white/5 border border-white/10 text-blue-400 rounded-2xl flex items-center justify-center mr-6 group-hover:bg-blue-600/20 group-hover:text-blue-300 transition-colors shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]">
                  <PhoneCall size={24} />
                </div>
                <div>
                  <h4 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-1">Secondary Contact</h4>
                  <p className="text-xl font-bold text-white tracking-tight">+91 9017130046</p>
                </div>
              </a>
          ...
          <motion.div 
            ...
            className="bg-slate-900/40 backdrop-blur-3xl p-4 rounded-[2rem] shadow-2xl border border-white/10 h-full min-h-[400px] overflow-hidden"
          >
            ...
            <iframe 
              ...
              className="w-full h-full rounded-[1.5rem] border-0 min-h-[350px] mix-blend-luminosity hover:mix-blend-normal transition-all duration-700 opacity-80 hover:opacity-100" 
